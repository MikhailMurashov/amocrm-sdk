...
- ``page`` — номер страницы (начиная с 1); если не передан — авто-пагинация
- ``limit`` — количество сделок на странице (максимум 250; по умолчанию 50 при авто-пагинации)
...
.. seealso::
   ...
   :doc:`pagination` — подробнее про авто-пагинацию и оба режима работы ``list()``.
